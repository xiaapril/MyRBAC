...
<script type="text/javascript">
    ...
    Ext.onReady(function() {
		...
		//根节点还是只能设置1个
		//var treejson = {id:"0",text:"菜单",expanded: true ,children:{id:"1",text:"aaa",isLeaf:true}};
    ...
    <div id="top" class="x-hide-display">
        <div>
        	...
        	<span style="float:right;padding-right:50px;padding-top:15px;font-size:12pt;">
        		当前用户：<c:out value="${sessionScope.com_user.user.realname}"/>
        		&nbsp;&nbsp;&nbsp;
        		当前时间：<span id="currentTime"></span>
        		&nbsp;&nbsp;&nbsp;
        		<s:a href="logout.action">退出</s:a>
        	</span>
        </div>
    </div>
